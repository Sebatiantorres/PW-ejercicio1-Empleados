...
if($_POST){
    ...
    */
    ...
    for($i=0; $i<5; $i++){
       ...
       if($sexo[$i] == "masculino" && $estadoCivil[$i] = "casado" && $sueldo > 2500){
            $casadosMayores++;
       }
...
<body>
    ...
    <div class="justify-content-center form-group ">
        <label for="name1">Empleado #1 Nombre y apellido</label>
    ...
    <div>
    <label for="name2">Empleado #2 Nombre y apellido</label>
    ...
    <div>
    <label for="name3">Empleado #3 Nombre y apellido</label>
    ...
    <div>
    <label for="name4">Empleado #4 Nombre y apellido</label>
    ...
    <div>
    <label for="name5">Empleado #5 Nombre y apellido</label>
    ...
    <input type="submit" name="btn" value="btn" class="btn btn-default">
